 ...
 */
    ...
    public void transfer(String id, String otherId, int password, long amount) {
    	...
    	System.out.println("상대방의 계좌잔액은 :" + otherBalance);
    	System.out.println("이체하신분의 계좌잔액은 :" + ownerBalance);
    }
    ...
    public void calculateCancellationRefund(String id, int password) {
    	...
    	long ownBalance = account.getBalance();
    	int yearDeposit = account.getDepositPeriod()/12;
    	double ownRate = account.getInterestRate();
