...
public class App5 {
	...
	public static void main(String[] args) {
		...
		intStream = IntStream.of(4,2,7,6,8,1,5);
		System.out.println("갯수 : "+IntStream.of(4,2,7,6,8,1,5).count());
		...
		//.sum() : 스트림의 요소의 합계를 반환한다. average() : 스트림 요소의 평균을 반환한다. 
		System.out.println("최대 : "+IntStream.of(4,2,7,6,8,1,5).sum());
		System.out.println("최대 : "+IntStream.of(4,2,7,6,8,1,5).average().getAsDouble());
