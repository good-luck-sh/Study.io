...
public class EmployeeDao {
	...
	public void insertEmployee(Employee employee) throws SQLException {
		String sql = "insert into employees (employee_id, first_name, last_name, email, job_id, salary, commission_pct, manager_id, department_id, hire_date ) "
		...
		ptmt.setString(4, employee.getJob().getId());
		ptmt.setDouble(5, employee.getSalary());
		ptmt.setDouble(6, employee.getCommissionPct());
		ptmt.setInt(7, employee.getManager().getId());
		ptmt.setInt(8, employee.getDepartment().getId());
		ptmt.executeUpdate();
	...
	public List<Employee> getAllEmployee() throws SQLException {
		List<Employee> employees = new ArrayList<>();
		String sql = "select employee_id, first_name, last_name, email, manager_id "
					+"from employees ";
		Connection connection = getConnection();
		PreparedStatement ptmt = connection.prepareStatement(sql);
		ResultSet rs = ptmt.executeQuery();
