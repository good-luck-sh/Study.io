...
public class CartController {
	...
	public String list(@LoginedUser User user,Model model) {
		...
		//} --> 앞으로 로그인 체크를 여기에서 하지 않겠다. 
		//사용자 번호로 장바구니 아이템정보를 조회한다.
		List<CarItemDto> dtos = cartItemService.getMyCartItems(user.getNo());
		//조회된 장바구니 아이템 정보를 뷰페이지로 전달하기 위해서 model에 저장한다.
