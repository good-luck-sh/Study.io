...
/*
 * HandlerInterceptor 
 * 		+ 컨트롤러의 요청 핸들러 메소드 실행 전처리/후처리를 구현하는 객체다.
 * 		+ 주요 API
...
public class LoginCheckInterceptor implements HandlerInterceptor {
	...
	@Override
	public void postHandle(HttpServletRequest request, HttpServletResponse response, Object handler, //post =현재
			ModelAndView modelAndView) throws Exception {
		logger.info("postHandle()가 실행됨");
		
	}
	
	@Override
	public void afterCompletion(HttpServletRequest request, HttpServletResponse response, Object handler, Exception ex) //after = 후
			throws Exception {
		logger.info("afterHandle()가 실행됨");
