...
public class Order {
	...
	public Order() {}
	public Order(int no, String userId, String producType, int productNo, int amount, Date orderDate,String status) {
		this.no = no;
		this.userId = userId;
	...
	public String toString() {
		return "Order [no=" + no + ", userId=" + userId + ", productType=" + productType + ", productNo=" + productNo
				+ ", amount=" + amount + ", status=" + status + ", orderDate=" + orderDate + ", cancelDate="
				+ cancelDate + "]";
	}
