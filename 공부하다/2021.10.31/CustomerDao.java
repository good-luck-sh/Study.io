...
public class CustomerDao {
	...
	public List<Customer> selectAllCustomers() throws SQLException {
		...
		String sql = "select customer_no, customer_name, customer_tel, customer_point, customer_in_put,customer_created_date "
		...
		while(rs.next()) {
			...
			customer.setInOut(rs.getString("customer_in_put"));
