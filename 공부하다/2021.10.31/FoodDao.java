...
public class FoodDao {
	...
	public List<Food> selectAllFoods() throws SQLException {
		...
		String sql = "select f.food_no, f.food_name, f.food_price, f.food_on_sale, f.category_no, c.category_name "
					+"from tb_sample_foods f and tb_sample_food_categories c "
	...
	private void repeatFood(List<Food> foods, ResultSet rs) throws SQLException {
		while(rs.next()) {
			...
			food.setNo(rs.getInt("f.food_no"));
			food.setName(rs.getString("f.food_name"));
			food.setPrice(rs.getInt("f.food_price"));
			food.setOnSale(rs.getString("f.food_on_sale"));
			category.setNo(rs.getInt("f.category_no"));
